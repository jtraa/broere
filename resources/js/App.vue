<style>
    #loader{
        ...
        background: linear-gradient(90deg, rgba(206,107,0,1) 0%, rgba(246,143,0,1) 50%, rgba(255,189,0,1) 100%);
    }
    .svg-calLoader {
        width: 230px;
        height: 230px;
...
<template>
    <div>
        ...
        <Navigation class="lg:order-1" id="top" v-bind="websiteData" :isActive="true" />
        <Header class="" v-bind="websiteData" :isActive="true" />
        <div class="flex flex-wrap justify-center items-center">
            <Booking class="w-full order-1 md:order-2" id="boeken" v-bind="websiteData" :isActive="true" />
...
import TwelveReasons from './components/TwelveReasons.vue';
